...
const SECTIONS = [
  {
    label: 'Analyze',
    items: [
      { to: '/', label: 'Dashboard', icon: I.Chart, end: true },
    ],
  },
  {
    label: 'Leads',
  ...
  return (
    <aside className="hidden md:flex w-60 shrink-0 flex-col bg-charcoal-875 border-r border-charcoal-800">
      <div className="px-5 pt-5 pb-3 flex items-center gap-2.5">
        <div className="h-8 w-8 rounded-lg bg-brand-500 flex items-center justify-center text-white font-bold">L</div>
        <div>
          <div className="text-sm font-semibold text-charcoal-100 leading-tight">LeadScout</div>
          <div className="text-[11px] text-charcoal-400 leading-tight">Cold outreach</div>
        </div>
      </div>
